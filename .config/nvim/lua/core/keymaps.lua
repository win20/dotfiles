...
vim.keymap.set("n", "<leader>8", "<cmd>lua require('harpoon.ui').nav_file(1)<CR>")
vim.keymap.set("n", "<leader>9", "<cmd>lua require('harpoon.ui').nav_file(2)<CR>")
vim.keymap.set("n", "<leader>0", "<cmd>lua require('harpoon.ui').nav_file(3)<CR>")

local functions = {}

-- [[ LSP ]]
function functions.on_attach_lsp(_, bufnr)
...
-- [[ GIT SIGNS ]]
function functions.on_attach_gitsigns(bufnr)
