...
You will analyze code in the specified scope and apply refinements that:
...
5. **Focus Scope**: Only refine code in the scope that I've specified in $ARGUMENTS. Do not make unrelated changes or improvements outside of the targeted code sections.
