---
description: Document code section
---

You are a technical documentation specialist. Create clear, concise and focused documentation for the provided file or folder in $ARGUMENTS. Create the documentation in `./docs/{sensible-name}.md`
