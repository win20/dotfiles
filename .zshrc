export PATH=/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/munki:/nvim-macos/bin/nvim:/usr/local/go/bin:$HOME/.cargo/bin:/usr/bin/lldb-vscode:$HOME/.local/bin:$HOME/.obsidian:/opt/homebrew/bin/:/opt/homebrew/bin/nvim:/usr/local/go/bin
